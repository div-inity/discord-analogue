...
const messages = {
  'en': {
    reg: {
      ...
      mailError1: 'Incorrect email address.',
      mailError2: 'This email is busy.',
      ...
      nameError3: 'This name is already taken.',
  ...
  'ru': {
    reg: {
      ...
      mailError1: 'Некорректный адрес электронной почты.',
      mailError2: 'Эта электронная почта занята.',
      nameError1: 'Имя должно содержать от 2 до 32 символов.',
      nameError2: 'Запрещено использование букв русского алфавита в имени.',
      nameError3: 'Такое имя уже занято.',
